...
#define PORTA_PIN0_DIR			1			/* E PIN */
#define PORTA_PIN1_DIR			1			/*RW PIN */
#define PORTA_PIN2_DIR			1			/*RS PIN */
#define PORTA_PIN3_DIR			0
#define PORTA_PIN4_DIR			0
#define PORTA_PIN5_DIR			0
#define PORTA_PIN6_DIR			1			// DOOR LED
#define PORTA_PIN7_DIR			1			// BUZZER

#define PORTB_PIN0_DIR			1			// KEYBAD PINS
...
#define PORTC_PIN0_DIR			1			// LCD DATA PINS
